...
chmod +x "$PROJECT_DIR/run.sh"
  ...
  echo -e "\n${YELLOW}${BOLD}Optimized for Apple Silicon M-series chips${RESET}"
  echo -e "\n${MAGENTA}Enjoy your Ultimate Llama AI Application! 🦙${RESET}"
}
...
if [[ "${BASH_SOURCE[0]}" == "${0}" ]]; then
  ...
  echo -e "\n${BLUE}${BOLD}🔧 Frontend files generated successfully${RESET}"
  echo -e "\n${BLUE}${BOLD}🔧 CLI files generated successfully${RESET}"
  echo -e "\n${BLUE}${BOLD}🔧 Docker configurations created${RESET}"
  echo -e "\n${BLUE}${BOLD}🔧 Kubernetes manifests generated${RESET}"
  echo -e "\n${BLUE}${BOLD}🔧 CI/CD workflows configured${RESET}"
