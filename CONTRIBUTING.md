# Contributing to Llama Ui

Thank you for your interest in contributing to Llama Ui! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Llama Ui:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llama-ui.git
   cd llama-ui
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llama-ui.git
   ```
...
By contributing to Llama Ui, you agree that your contributions will be licensed under the project's MIT License.
